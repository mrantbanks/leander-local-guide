...
export default async function AdminPage() {
  ...
  const pend = await pool.query("select ((select count(*) from photos where status='pending') + (select count(*) from tips where status='pending') + (select count(*) from reviews where status='pending') + (select count(*) from claims where status='pending'))::int n");
