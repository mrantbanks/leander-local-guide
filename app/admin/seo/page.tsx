...
export default async function AdminSeoHome() {
  ...
  return (
    <main className="px-5 py-6 max-w-4xl">
      ...
      <p className="font-ui text-sm text-ink-soft mb-6">See exactly what Google sees for any page, preview the search result a visitor gets, and edit the title and description. Pick a restaurant to inspect its main page and menu page.</p>
      ...
      <section>
        ...
        <p className="font-ui text-xs text-ink-soft mb-3">Read-only previews of the site&apos;s non-restaurant pages. Their titles live in the page code; edit them there.</p>
            ...
            <div key={p.key} className="border border-rule rounded-[2px] p-3 bg-paper-raised">
              <div className="flex items-center justify-between gap-2 mb-2">
                ...
                <div className="flex items-center gap-2">
                  <a href={`https://leanderlocalguide.com${p.path}`} target="_blank" rel="noreferrer" className="font-stamp uppercase tracking-[0.06em] text-[10px] text-ink-soft hover:text-chile">Live ↗</a>
                  <a href={`https://search.google.com/test/rich-results?url=${encodeURIComponent('https://leanderlocalguide.com' + p.path)}`} target="_blank" rel="noreferrer" className="font-stamp uppercase tracking-[0.06em] text-[10px] text-chile hover:text-oxblood">Test ↗</a>
                </div>
              </div>
