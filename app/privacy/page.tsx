...
const SECTIONS: { h: string; body: string }[] = [
  ...
  { h: 'The Local Passport', body: `When you open a Passport stamp, and when an owner confirms one at their counter, we record that it happened, which perk it was, and the random device cookie above. That is how we can tell a business how many locals the guide actually sent them. We count anonymous stamp interactions, not people: the cookie is a random identifier and we never join it to your name, email, IP address, or account. If you clear it you simply look like a new device, and we accept the undercount rather than track you more closely.` },
