...
export function guideBody(o: GuideOpts): string {
  ...
  <div class="gsteps">
    ...
    <div class="gstep"><div class="gnum">3</div><div><h3>Post a "Locals Only" deal — your own coupon</h3><p>Pick a deal or write your own, preview the ticket, and post it. Leander locals pull up a printable <b>Local's Ticket</b> to show you in-house. Honor system — you decide what to give, and you set when it ends (run an ongoing one with zero upkeep, or a short weekend push). Run as many as you like.</p><p style="margin-top:5px;"><b>Steal one of these:</b> 10% off for Leander locals · Free appetizer with any two entrees · Free queso with orders over $25 · Kids eat free on Tuesdays · Free drink with any meal · $5 off your first visit. Make it yours — your dish, your deal, your call.</p></div></div>
