  ...
  <div class="cols">
    ...
    <div class="col">
      ...
      <ul class="manage">
        ...
        <li>Add a <b>Local Passport</b> perk — locals pull up a stamp to show you</li>
...
export function guideBody(o: GuideOpts): string {
  ...
  <div class="gsteps">
    ...
    <div class="gstep"><div class="gnum">3</div><div><h3>Add a perk to the Local Passport</h3><p>Pick a perk to start from or write your own, preview the stamp, and post it. Leander locals pull up a printable <b>Passport stamp</b> to show you at the counter. Honor system — you decide what to give, and you set when it ends (run an ongoing one with zero upkeep, or a short weekend push). Run as many as you like.</p><p style="margin-top:5px;"><b>Examples to start from:</b> 10% off for Leander locals · Free appetizer with any two entrees · Free queso with orders over $25 · Kids eat free on Tuesdays · Free drink with any meal · $5 off your first visit. Make it yours — your dish, your perk, your call.</p></div></div>
    <div class="gstep"><div class="gnum">4</div><div><h3>See who's watching</h3><p>Your desk shows how many locals want to try you and have vouched for you. Good week to put a perk up? Now you'll know.</p></div></div>
  </div>
