  ...
  return (
    <div className="ticket w-full max-w-sm bg-paper border-2 border-ink shadow-xl mx-auto">
      <div className="text-center px-6 pt-6 pb-4 border-b-2 border-dashed border-ink">
        ...
        <p className="font-stamp uppercase tracking-[0.16em] text-ink-soft text-[12px]">The Leander Local Guide · for locals only</p>
      </div>
      <div className="px-6 py-6 text-center">
        <p className="font-stamp uppercase tracking-[0.1em] text-ink-soft text-[12px] mb-1">A perk from</p>
        ...
        <pre aria-hidden="true" className="mt-5 inline-block text-left font-mono text-[12px] leading-[1.15] text-ink/80">{pickStampArt(restaurant, title)}</pre>
      </div>
      <div className="px-6 py-4 border-t-2 border-dashed border-ink text-center bg-paper-raised">
        ...
        <p className="font-ui text-[12px] text-ink-soft mt-1">Leander locals only · one per visit · owner&apos;s discretion</p>
        {today && <p className="font-stamp uppercase tracking-[0.1em] text-[12px] text-ink-soft mt-2">Stamped {today}</p>}
      </div>
    </div>
  );
}
