    ...
    <nav className="sticky top-0 z-50 bg-paper/95 backdrop-blur-sm border-b border-rule">
      <div className="max-w-6xl mx-auto px-4 sm:px-5 flex items-center justify-between gap-2 h-14">
        <Link href="/" className="flex items-baseline gap-2 shrink-0">
          ...
          <span className="hidden md:inline font-stamp uppercase tracking-[0.18em] text-sm text-chile">Local First</span>
        </Link>
        ...
        <div className="flex items-center gap-1 sm:gap-2 min-w-0">
          ...
          <div ref={moreRef} className="relative sm:hidden shrink-0">
            ...
            >
              More <span aria-hidden="true" className={`inline-block text-sm transition-transform duration-150 ${moreOpen ? 'rotate-180' : ''}`}>▾</span>
            </button>
            {moreOpen && (
