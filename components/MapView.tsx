  ...
  return (
    <div className="flex flex-col" style={{ height: 'calc(100dvh - 56px)' }}>
      ...
      <div className="relative flex-1 min-h-0">
        ...
        {userLoc && filtered.length > 0 && <div className="absolute bottom-2 left-2 z-10 bg-paper/90 border border-rule px-2 py-1 font-ui text-[10px] text-ink-soft rounded-sm">Sorted by nearest · your location stays in your browser</div>}
      </div>
    </div>
  );
}
