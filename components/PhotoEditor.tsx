          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="flex gap-1.5 mb-2">
                <button onClick={() => runGemini(ENHANCE)} disabled={!!busy} className="flex-1 font-stamp uppercase tracking-[0.06em] text-sm bg-chile text-paper py-2 rounded-sm disabled:opacity-50">⚡ Auto-enhance</button>
                <button onClick={() => runGemini(MENU_FIX)} disabled={!!busy} className="flex-1 font-stamp uppercase tracking-[0.06em] text-sm bg-ink text-paper py-2 rounded-sm disabled:opacity-50">📋 Fix menu</button>
              </div>
